...
(function( $ )
{
    ...
    $.extend(Wysiwyg, {
        ...
        MSGS_EN : {
            nonSelection : 'Seleccione el texto que desea vincular'
        },

        TOOLBAR : {
			undo : { visible : true, tooltip : "Deshacer escritura" },
            redo : { visible : true, tooltip : "Rehacer escritura" },
            ...
            justifyLeft   : { visible : true, css : { textAlign : 'left' }, tooltip : "Alinear texto a la izquierda" },
            justifyCenter : { visible : true, tags : ['center'], css : { textAlign : 'center' }, tooltip : "Centrar" },
            justifyRight  : { visible : true, css : { textAlign : 'right' }, tooltip : "Alinear texto a la derecha" },
            justifyFull   : { visible : true, css : { textAlign : 'justify' }, tooltip : "Justificar" },

            separator02 : { visible : true, separator : true },
			
			outdent : { visible : true, tooltip : "Disminuir sangría" },
            indent  : { visible : true, tooltip : "Aumentar sangría" },

            separator03 : { visible : true, separator : true },

            subscript   : { visible : true, tags : ['sub'], tooltip : "Subíndice" },
            superscript : { visible : true, tags : ['sup'], tooltip : "Superíndice" },
			
            separator04 : { visible : true, separator : true },
			
            insertOrderedList    : { visible : true, tags : ['ol'], tooltip : "Numeración" },
            insertUnorderedList  : { visible : true, tags : ['ul'], tooltip : "Viñetas" },
            insertHorizontalRule : { visible : true, tags : ['hr'], tooltip : "Línea Horizontal" },
            ...
            increaseFontSize : { visible : true && !( $.browser.msie ), tags : ['big'], tooltip : "Agrandar fuente" },
            decreaseFontSize : { visible : true && !( $.browser.msie ), tags : ['small'], tooltip : "Encoger fuente" },
