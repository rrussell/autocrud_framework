			...
			<div id="menu">
				...
				<table>
					<tr>
						...
						<?php endif ?>
						<?php if($f->get_var_session('section') == 'img_productos') : ?>
						<td class="link" onclick="location.href='<?= BASE_URL ?>productos'">
							<a href="<?= BASE_URL ?>productos">Volver a Lista de Productos</a>
						</td>
						<?php endif ?>
						<?php if($f->menu() && $f->get_var_session('section') == 'subproductos') : ?>
						<td class="link" onclick="location.href='<?= BASE_URL ?>productos'">
							<a href="<?= BASE_URL ?>productos">Volver al Productos</a>
						</td>
						<?php endif ?>
						<td>
